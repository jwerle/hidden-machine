...
function wrap(code) {
  const context = `
    const module = ('undefined' !== typeof require ? new (require('module')).Module()
      : 'undefined' !== typeof global.process.mainModule ? new global.process.mainModule.constructor()
      : null);

    if (!module) {
      throw new TypeError("Failed to construct parent module for hidden machine.");
    }

    module.parent = global.process.mainModule || null;
  `
